        ...
        let maquinaHTML = `
            <div class="maquina ${alerta ? 'alerta' : ''} ${isInMaintenance ? 'maintenance' : ''}">
                <div class="maquina-header">
                    <div class="maquina-id maquina-id-clickable" onclick="wmAbrirModalMaquinaDashboard('${id}')" title="Abrir histórico desta máquina"><i class="fas fa-industry"></i> Máquina <span class="maquina-codigo">${id}</span></div>
                    ${wmRenderCardTimeMeta(m)}`;
